...
const Sidebar = () => {
  return (
    <div className="flex w-[260px] flex-col border-r-[1px] border-r-slate-600 bg-slate-900 text-white">
      <div className="flex items-center border-b-[1px] border-b-slate-600 px-3 py-4">
        ...
        <div className="flex min-h-[32px] w-[32px] cursor-pointer items-center justify-center bg-slate-800 py-1">
          <BsChevronLeft size={12} />
        </div>
      </div>
      <div className="flex flex-1 flex-col border-b-[1px] border-b-slate-600 py-3">
        <ul className="mb-2">
          <li className="flex min-h-[32px] cursor-pointer py-1 pl-4 hover:bg-slate-800">
          ...
          <li className="min-min-h-[32px] flex cursor-pointer py-1 pl-4 hover:bg-slate-800">
            <a href="" className="flex w-full items-center gap-3">
              <BsFillGrid1X2Fill size={12} />
              <div className="flex-1 text-[14px]">Các cài đặt không gian làm việc</div>
              <div className="flex w-[32px] items-center justify-center">
        ...
        <ul className="mb-2">
          <div className="fon flex min-h-[32px] items-center py-1 pl-2 text-[14px] font-bold">
        ...
        <ul className="mb-2">
          ...
          {children.map((item) => {
            return (
              <li
                className="flex min-h-[32px] cursor-pointer items-center gap-3 py-1 pl-4 hover:bg-slate-800"
                key={item.id}>
